module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		copy : {
			...
			mp3 : {
				files : [ {
					expand : true,
					cwd : '../../www/resources-dev/front/mp3/',
					src : [ '**' ],
					dest : '../../www/resources/front/mp3/'
				} ],
			},
		},
	});
	...
	grunt.registerTask('build', [ 'clean:primary', 'clean:beforeAndAfterBuild', 'copy:jsvendor', 'copy:fonts', 'copy:mp3', 'concat:build', 'uglify:build', 'lesslint', 'less:build', 'csscomb:build', 'autoprefixer:build',
